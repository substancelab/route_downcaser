...
Array of regular expressions. If this option is present, only included patterns will be downcased. All other URLs will not be changed. If a pattern is present in both include_patterns and exclude_patterns, it will not be changed.
